...
package body Aw_Lib.String_Util is
	...
	function implode(	Sep: Character;
				Vect: Aw_Lib.UString_Vectors.Vector ) return String is
	...
	function implode(	Sep: Character; 
				Vect: Aw_Lib.UString_Vectors.Vector ) return Unbounded_String is
	...
	function explode(	Sep: Character; 
				Str: Unbounded_String ) return Aw_Lib.UString_Vectors.Vector is
